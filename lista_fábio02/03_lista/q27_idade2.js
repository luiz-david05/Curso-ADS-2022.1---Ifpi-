...
function main(){
    ...
    if(dia_atual === dia_nascimento && mes_atual === mes_nascimento && ano_atual === ano_nascimento ){
...
function calcular_idade (dia_1, mes_1, ano_1, dia_2, mes_2, ano_2){
    ...
    console.log(`idade: ${diferenca_anos} anos, ${diferenca_meses} meses e ${diferenca_dia} dias`)
}